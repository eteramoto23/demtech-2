...
pacman::p_load(tidyverse,
               ...
               ggplot2,
               writexl)
here::i_am("problemset1_teramoto.qmd")
library(here)
here()
...
d <- read_csv("data/ps1_data_F2023.csv")
...
write_xlsx(d1,
          path = here::here("tables","lifetable.xlsx"))       
...
g
    ...
    ggsave(plot = g, 
       filename = here::here("figures","ps1_fig1.jpeg"), 
       device = "jpeg", 
       units = "cm",
       width = 20,
       height = 12, 
...
g2
    ...
    ggsave(plot = g2, 
       filename = here::here("figures","ps1_fig2.png"), 
       device = "jpeg", 
       units = "cm",
       width = 20,
       height = 12, 
